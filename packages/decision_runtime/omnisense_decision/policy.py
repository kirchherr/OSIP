...
class RoomsDecisionPolicy:
    ...
    @staticmethod
    def priority(event: ContextEvent, contract: ActionContract) -> ActionPriority:
    ...
    @staticmethod
    def requires_confirmation(contract: ActionContract) -> bool:
        return contract.risk_class in {"high", "critical"}

    @staticmethod
    def reason(event: ContextEvent, contract: ActionContract) -> str:
        return (
            f"{event.label} matched {contract.action_id} "
